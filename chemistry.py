...
def main():
    ...
    sep_list=parse_formula(formula,table)
    molar_mass=compute_molar_mass(sep_list,table)
    print(f"Molar mass: {molar_mass:.05}")
    number_of_moles=mass/molar_mass
    print(f"Number of moles: {number_of_moles:.05}")
